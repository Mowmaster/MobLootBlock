...
public class MobLootItem extends Item
{
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        MutableComponent mob = EntityType.byString(MowLibCompoundTagUtils.readStringFromNBT(moblootblock.MODID,p_41421_.getOrCreateTag(),"moblootitem")).get().getDescription().copy();
